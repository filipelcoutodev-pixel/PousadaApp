 ...
 */
package br.com.senacead.pousadaappjpa.Utilitaria;
...
public class FuncService {
    ...
    /**
 * Busca um quarto pela sua identificação (número ou nome).
 *
 * @param identificacao String que representa a identificação do quarto,
 *                      por exemplo "1", "101" ou "Casal + Beliche".
 * @return Objeto Quarto correspondente à identificação informada,
 *         ou null caso não seja encontrado.
 */
public Quarto buscarQuartoPorIdentificacao(String identificacao) {
    return quartoDAO.buscarQuartoPorIdentificacao(identificacao);
}
