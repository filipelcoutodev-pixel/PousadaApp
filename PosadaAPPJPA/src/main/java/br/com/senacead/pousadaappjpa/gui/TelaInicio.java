...
//Método para atualizar o PainelCaixa
    ...
    public void atualizarTabelaHospede(List<Hospede> hospedes) {
        ...
        for (Hospede h : hospedes) {
            dados[i] = new String[]{
                ...
                h.getQuarto() != null ? h.getQuarto().getIdentificacao() : "—",
    ...
    private void initComponents() {
        ...
        cbxQuarto.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
...
// Validação do contato
        ...
        if (quartoSelecionado == null) {
            mostrarMensagemRapida("Nenhum quarto selecionado.");
            return;
        }

        hospede.setQuarto(quartoSelecionado);

        try {
            valorDiaria = Double.parseDouble(JOptionPane.showInputDialog("Entre com o valor da diária: "));
    ...
    private void btnRelatorioCompletoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRelatorioCompletoActionPerformed
        ...
        mostrarMensagemRapida("Relatório Completo Gerado!");
    ...
    private void btnRelatorioResumidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRelatorioResumidoActionPerformed
        ...
        mostrarMensagemRapida("Relatório Resumido Gerado!");
