...
public class HospedeDAO {
    ...
    try {
        ...
        Quarto quarto = em.find(Quarto.class, h.getQuarto().getId());
        int ocupados = quarto.getHospedes().size();

        if (ocupados >= quarto.getCapacidadeMaxima()) {
            JOptionPane.showMessageDialog(null,
                "Quarto " + quarto.getIdentificacao()+ " já está cheio!",
                "Aviso",
